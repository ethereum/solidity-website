...
It is, however, important to note that we are relaxing these restrictions because the checks were ultimately artificially imposing
*deployed* contract immutability restrictions on contract creation for consistency and not for security reasons.
While some restrictions still remain - such as inability to initialize immutables in functions and modifiers -
we hope to drop these as well eventually.
